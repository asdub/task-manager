...
class TestTasksDashboard(APITestCase):
    ...
    def test_task_dashboard_completion(self):
        ...
        # Create task via api and db query,
        # test and update task object completion status and test
    ...
    def test_task_category_distribution(self):
        ...
        response = self.client.get(
            reverse('tasks-category-distribution-list')
        )
